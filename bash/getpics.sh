...
test -f ~/public_html/pics.zip || wget -q -O ~/public_html/pics/pics.zip http://zonzorp.net/pics.zip && unzip -d ~/public_html/pics -o -q ~/public_html/pics/pics.zip && rm ~/public_html/pics/pics.zip
test -f ~/public_html/pics.tgz || wget -q -O ~/public_html/pics/pics.tgz http://zonzorp.net/pics.tgz && tar -C  ~/public_html/pics -xvf ~/public_html/pics/pics.tgz && rm ~/public_html/pics/pics.tgz
# Task 1: Improve this script to also retrieve and install the files kept in the https://zonzorp.net/pics.tgz tarfile
